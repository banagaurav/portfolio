    ...
    <section className="min-h-screen w-full flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-12 text-white">
      ...
      <div className="flex-1 flex flex-col justify-center space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-4xl font-bold text-[#3776AB] tracking-wide">
            Python
          </h2>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-4xl font-bold text-[#512be7] tracking-wide">
            Pandas
          </h2>
        </div>
        ...
        <p className="text-gray-300 text-lg leading-relaxed mt-12 max-w-xl">
          I specialize in{" "}
          <span className="text-[#3776AB] font-semibold">data engineering</span>{" "}
          and <span className="text-[#512be7] font-semibold">analysis</span>{" "}
          using <span className="text-[#3776AB] font-semibold">Python</span>{" "}
          with <span className="text-[#512be7] font-semibold">Pandas</span>,
          building powerful data processing capabilities into backend systems.
          Python provides the foundation for scalable data workflows, while
          Pandas enables efficient manipulation and analysis of complex
          datasets. This expertise allows me to create data pipelines, implement
          analytical features, and transform raw data into actionable insights
