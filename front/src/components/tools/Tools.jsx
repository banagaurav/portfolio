      ...
      <section className="min-h-screen w-full flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-12 text-white">
         ...
         <div className="flex-1 flex flex-col justify-center space-y-8">
            ...
            <div className="flex items-center gap-4">
               ...
               <h2 className="text-4xl font-bold tracking-wide text-[#FEBE0D]">Figma</h2>
            </div>

            {/* Description */}
            <p className="text-gray-300 text-lg leading-relaxed max-w-xl">
               I use <span className="text-[#FEBE0D] font-semibold">Figma</span> to design my projects before coding. It
