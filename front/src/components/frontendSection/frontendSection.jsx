         ...
         <div className="flex-1 w-full flex flex-col justify-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-10 gap-y-8">
               {[
                  ...
                  <div key={index} className="flex items-center gap-4 group hover:scale-105 transition-transform">
                     <Image
                        src={tech.src}
                        alt={`${tech.name} icon`}
                        width={40}
                     ...
                     />
                     <p className={`text-2xl font-semibold ${tech.color}`}>{tech.name}</p>
                  </div>
               ))}
            </div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mt-16 max-w-xl">
               ...
               <span className="text-[#38BDF8] font-medium">TailwindCSS</span>. This stack allows me to build scalable,
               fast, and maintainable web applications with beautiful, component-driven interfaces and smooth user
               experiences.
            </p>
         </div>
