   ...
   return (
      ...
      >
         ...
         <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-[#FEBE0D]">Experience & Education</h2>
            <p className="text-gray-300 max-w-2xl mx-auto mt-4">
               Here's a summary of my professional experience and educational background. You can also view my full
               resume.
            </p>
            <div className="mt-8">
               <a
         ...
         <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
               <div className="flex items-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-[#FEBE0D]">Work Experience</h3>
               </div>
               <div className="space-y-10">
                  {experiences.map((exp) => (
                     <div key={exp.id} className="relative pl-8 border-l-2 border-[#FEBE0D]">
                        <div className="absolute w-4 h-4 rounded-full -left-2 top-2 bg-[#FEBE0D]" />
                        <h4 className="text-xl font-semibold text-[#FEBE0D]">{exp.role}</h4>
            ...
            <div>
               ...
               <div className="space-y-10">
                  {education.map((edu) => (
                     <div key={edu.id} className="relative pl-8 border-l-2 border-[#FEBE0D]">
                        <div className="absolute w-4 h-4 rounded-full -left-2 top-2 bg-[#FEBE0D]" />
                        <h4 className="text-xl font-semibold text-[#FEBE0D]">{edu.degree}</h4>
                        <div className="flex items-center mb-2 text-gray-300">
               ...
               <div className="mt-16">
                  <div className="flex items-center mb-8">
                     ...
                     <h3 className="text-2xl font-bold text-[#FEBE0D]">Certifications</h3>
                  </div>
                  <div className="space-y-4">
                     {certifications.map((cert) => (
                        <div key={cert.id} className="pl-8 border-l-2 border-[#FEBE0D] relative">
                           <div className="absolute w-4 h-4 rounded-full -left-2 top-2 bg-[#FEBE0D]" />
                           <h4 className="text-lg font-semibold text-[#FEBE0D]">{cert.title}</h4>
